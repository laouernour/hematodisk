...
class Accueil(ct.CTk):
    def __init__(self):
        ...
        # Top frame
        self.top_frame = ct.CTkFrame(self, fg_color='#78BDCC', width=w, height=150, corner_radius=0)
        ...
        label_text = Label(self.top_frame, text="Hemato disk", font=('Karla', 48, 'bold'), bg="#78BDCC")
